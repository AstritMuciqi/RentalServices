<?php 
    ...
    $rental = $rentalController->getRental($_GET['id']);
    if(($_SERVER['REQUEST_METHOD'] == 'POST')){
        
        $rentalController->editRental($_GET['id']);
            ...
            <div id="add-movie-form-container">
                <form class="form-horizontal" method="post" id="edit-car-form" action='' autocomplete="off" enctype="multipart/form-data" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="title" placeholder="" name="rental_name" value="<?= $rental[0]['rental_name'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <img src="../../<?= $rental[0]['img_path'] ?>" width="194" height="259" style="margin-buttom:15px" alt="">
